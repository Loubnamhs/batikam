...
PDF_HEADER_LOGO_WIDTH_CM        =  6.2
PDF_HEADER_LOGO_HEIGHT_CM       =  2.7
PDF_HEADER_LOGO_X_OFFSET_CM     =  0.0
PDF_HEADER_LOGO_BOX_HEIGHT_CM   =  2.7
...
DOCX_HEADER_LOGO_WIDTH_CM       =  4.2
DOCX_HEADER_LOGO_HEIGHT_CM      =  2.0
...
DOCX_HEADER_LEFT_COL_CM   = 10.8
DOCX_HEADER_RIGHT_COL_CM  =  7.8
DOCX_LINE_TABLE_WIDTHS_CM = (9.5, 1.5, 1.8, 2.5, 3.3)
...
LINE_TABLE_HEADERS = ["Description des travaux", "Qté", "Unité", "PU HT", "Total HT"]
